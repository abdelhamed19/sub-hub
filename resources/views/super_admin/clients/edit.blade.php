    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('super_admin.client.update', $client->id) }}" method="POST"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="email" name="email"
                                    ...
                                    value="{{ old('email', $client->email) }}" required id="inputEmail5">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="name"
                                    ...
                                    value="{{ old('name', $client->name) }}" required id="inputName5">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="phone"
                                    ...
                                    value="{{ old('phone', $client->phone) }}" required id="inputPhone5">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="legal_name"
                                    ...
                                    value="{{ old('legal_name', $client->legal_name) }}" required id="inputLegalName5">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="alternative_phone"
                                    ...
                                    value="{{ old('alternative_phone', $client->alternative_phone) }}" required
                                    id="inputAlternativePhone5">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="address"
                                    ...
                                    value="{{ old('address', $client->address) }}" required id="inputAddress5">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="city"
                                    ...
                                    value="{{ old('city', $client->city) }}" required id="inputCity5">
                                ...
                                <select id="inputCountry5" name="country" required
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->code }}"
                                            {{ old('country', $client->country) == $country->code ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="url" name="website"
                                    ...
                                    value="{{ old('website', $client->website) }}" required id="inputWebsite5">
                                ...
                                <select name="business_type" class="form-control">
                                    ...
                                    @foreach (App\Enums\BusinessType::cases() as $type)
                                        <option value="{{ $type->value }}"
                                            {{ old('business_type', $client->business_type) === $type->value ? 'selected' : '' }}>
                                            {{ $type->label() }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="industry" class="form-control">
                                    ...
                                    @foreach (App\Enums\IndustryType::cases() as $type)
                                        <option value="{{ $type->value }}"
                                            {{ old('industry', $client->industry) === $type->value ? 'selected' : '' }}>
                                            {{ $type->label() }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputStatus" name="is_active" required
                                    ...
                                    <option selected>{{ __('mutual.choose') }}...</option>
                                    <option value="1"
                                        {{ old('is_active', $client->is_active) == 1 ? 'selected' : '' }}>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="tax_id"
                                    ...
                                    value="{{ old('tax_id', $client->tax_id) }}" required id="inputTaxId5">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="commercial_registration"
                                    ...
                                    required id="inputCommercialRegistration5">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="employees_count"
                                    ...
                                    value="{{ old('employees_count', $client->employees_count) }}" required
                                    id="inputEmployeeCount5">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" id="inputNotes" rows="1">{{ old('notes', $client->notes) }}</textarea>
