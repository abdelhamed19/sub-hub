<x-super-admin.super-admin-layout-component :title="__('super_admin.create_plan')">
    <x-super-admin.flash-message-component />
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <strong class="card-title">{{ __('super_admin.create_plan') }}</strong>
                </div>
                <div class="card-body">
                    <form action="{{ route('super_admin.plan.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="price"
                                    ...
                                    value="{{ old('price') }}" id="inputPrice5">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputComparePrice5">{{ __('mutual.compare_price') }}</label>
                                <input type="number" name="compare_price"
                                    class="form-control @error('compare_price') is-invalid @enderror"
                                    value="{{ old('compare_price') }}" id="inputComparePrice5">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="duration_days"
                                    ...
                                    value="{{ old('duration_days') }}" id="inputDurationDays5">
                                <x-validation-message-component field="duration_days" />
                            </div>

                            <div class="form-group col-md-6">
                                <label for="inputDes5">{{ __('mutual.description') }}</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="features-list mt-2"
                                    ...
                                    <!-- حقل أولاني جاهز عشان المستخدم ميبدأش من الصفر -->
                                    <div class="feature-item d-flex align-items-center p-2 bg-light rounded border">
                                        ...
                                        <input type="text" name="features[]"
                                            ...
                                            placeholder="اكتب مميزة هنا..." style="outline: none; box-shadow: none;">
                                ...
                                <small class="form-text text-muted mt-2">
                                    يمكنك إضافة أكثر من مميزة، وسيتم حفظها جميعًا مع الخطة.
                                </small>
                            </div>
                        </div>
